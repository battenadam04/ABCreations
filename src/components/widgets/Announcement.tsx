...
const Announcement = () => {
  ...
  return (
    <div className=" hidden overflow-hidden text-ellipsis whitespace-nowrap border-b border-blue-900 bg-blue-900 px-3 py-4 text-sm md:block">
      ...
      <Form {...contactHome.form} containerClass="flex h-9 md:flex-row float-right" btnPosition="right" customErrorStyling='absolute w-md mb-0 w-fit rounded-md' customValidation={annoucementSchema} customSubmission={onSubmit}/>
      )}
    </div>
  );
};
